...
- [ ] В цикле получить все необходимые данные о заказе и сформировать соответствующий json-объект. Этот json-объект должен соответствовать API МойСклад.
- [ ] Отправить в МойСклад только заказы со статусом **delivered**
